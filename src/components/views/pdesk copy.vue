...
<template>
  <div class="productmain">
    <div class="proheader" id="proheader">
      <img src="@/../static/imgs/product/desk/Map-Table-Ambience.jpg" width="100%;height:100%" alt="">
      <div class="proheaderF">
        <div class="T1">DESK <span>桌</span></div>
        <span class="T2">不只是一个平面， 更是你尽情涂抹的画布。</span>
        <span class="T3">A desk is not just a surface. It is actually a canvas for your passionate painting.</span>
        <span class="T3"></span>
        <span class="T4"></span>
      </div>
    </div>
