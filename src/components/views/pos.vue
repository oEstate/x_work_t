...
<template>
  <div class="productmain">
    <div class="proheader" id="proheader">
      <img src="@/../static/imgs/product/os/os.jpg" width="100%;height:100%" alt="">
      <div class="proheaderF">
        <div class="T1 mEN">OFFICE SYSTEM <span>办公系统</span></div>
        <span class="T2">将丰富的变化融入相对固定的工位之间，
                         适应不同企业文化下的独特工作模式，
                         成为企业高效运转平台。</span>
        <span class="T3">Although workstations are relatively fixed in workspaces,</span>
        <span class="T3">they can still be flexible and productive platforms
                         to accommodate varied work styles under different cultures.</span>
        <span class="T4"></span>
      </div>
    </div>
    <div class="probody">
      <div class="probodyleft">
        <div id="PBL">
          <span class="probodylefttitle">筛选办公系统</span>
          <!-- <div class="iteminput">
  ...
  export default {
    data() {
      return {
        ...
        allchairs: [{
            id: 1,
            imgSrc: "@/../static/imgs/product/os/Joyn.png",
            hoverimg:"@/../static/imgs/product/os/Joyn Workstations.jpg",
            T1: "JOYN WORKSTATIONS",
          ...
          {
            id: 2,
            imgSrc: "@/../static/imgs/product/os/Note.png",
            hoverimg:"@/../static/imgs/product/os/Note.jpg",
            T1: "NOTE",
            T2: "James Guo",
            flag: ["S1","S2","S4","T2"]
          },
          {
            id: 3,
            imgSrc: "@/../static/imgs/product/os/Workbays.png",
            hoverimg:"@/../static/imgs/product/os/Workbays.jpg",
            T1: "WORKBAYS",
            T2: "Ronan & Erwan Bouroullec",
            route:"/workbays",
            flag: ["S1","S2","S3","S5","T1","T2"]
          }
        ],
        chairs: []
      };
    ...
    methods: {
      ...
      initTitle() {
        if (this.active.length == 0) {
          this.chairTitle = "所有系统工位";
          this.chairCount = this.allchairs.length;

        } else {
          this.chairTitle = "所选系统工位";
          this.chairCount = this.chairs.length;
        }
      },
      initRrselect() {
