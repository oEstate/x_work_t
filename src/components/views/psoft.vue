...
<template>
  <div class="productmain">
    <div class="proheader" id="proheader">
      <img src="@/../static/imgs/product/soft/soft.jpg" width="100%;height:100%" alt="">
      <div class="proheaderF">
        <div class="T1 mEN">DECORATION <span>软装配饰</span></div>
        <span class="T2">有时你的空间只需要最后一笔点睛亮点，
                         就能拥有生动灵魂。</span>
        <span class="T3">Sometimes, you just need to give an artful touch to your space to enliven it.</span>
        <span class="T3"></span>
        <span class="T4"></span>
      </div>
    </div>
    <div class="probody">
      <div class="probodyleft">
        <div id="PBL">
          <span class="probodylefttitle">筛选软装配饰</span>
          <div class="iteminput">
  ...
  export default {
    data() {
      return {
        ...
        allchairs: [{
            id: 1,
            imgSrc: "@/../static/imgs/product/soft/Canevas-Geo.png",
            hoverimg: "@/../static/imgs/product/soft/Canevas Geo.jpg",
            T1: "CANEVAS GEO",
            T2: "Charlotte Lancelot",
            route:"/CanevasGeo",
            flag: ["C1"]
          },
          {
            id: 2,
            imgSrc: "@/../static/imgs/product/soft/Mangas-Original.png",
            hoverimg: "@/../static/imgs/product/soft/Mangas Original.jpg",
            T1: "MANGAS ORIGINAL",
            T2: "Patricia Urquiola",
            route:"/MangasOrigina",
            flag: ["C1"]
          },
          {
            id: 3,
            imgSrc: "@/../static/imgs/product/soft/Mix-&-Match.png",
            hoverimg: "@/../static/imgs/product/soft/Mix & Match.jpg",
            T1: "MIX & MATCH",
            T2: "Flavia del Pra",
            route:"/MixMatch",
            flag: ["C2"]
          ...
          {
            id: 4,
            imgSrc: "@/../static/imgs/product/soft/Silaï.png",
            hoverimg: "@/../static/imgs/product/soft/Silaï.jpg",
            T1: "SILAÏ",
            T2: "Charlotte Lancelot",
            route:"/Silai",
            flag: ["C1"]
    ...
    methods: {
      ...
      initTitle() {
        if (this.active.length == 0) {
          this.chairTitle = "所有软装配饰";
          this.chairCount = this.allchairs.length;

        } else {
          this.chairTitle = "所选软装配饰";
          this.chairCount = this.chairs.length;
        }
      },
      initRrselect() {
