  ...
  <div class="productmain">
    <div class="proheader" id="proheader">
      ...
      <div class="proheaderF">
        <div class="T1 mEN">SPACE DIVISION <span>空间分隔</span></div>
    ...
    data() {
      return {
        ...
        allchairs: [{
            ...
            hoverimg: "@/../static/imgs/product/space/Algue.jpg",
            T1: "ALGUE",
          ...
          },
          {
            ...
            hoverimg: "@/../static/imgs/product/space/Clouds.jpg",
            T1: "CLOUDS",
            T2: "Ronan & Erwan Bouroullec",
            route:"Clouds",
            flag: []
          },
          {
            ...
            hoverimg: "@/../static/imgs/product/space/Pop.jpg",
            T1: "POP",
            T2: "Rongjie Yang",
            route:"/Pop",
            flag: []
          },
          {
            ...
            hoverimg: "@/../static/imgs/product/space/Uni.jpg",
            T1: "UNI",
            T2: "Miiko He",
            route:"/Uni",
            flag: []
